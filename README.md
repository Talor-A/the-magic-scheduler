...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/the-magic-scheduler
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/the-magic-scheduler_test
```
