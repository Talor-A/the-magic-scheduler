...
-- AlterTable
ALTER TABLE "Membership" ADD COLUMN     "eventId" INTEGER;

-- DropTable
DROP TABLE "_EventToUser";

-- AddForeignKey
ALTER TABLE "Membership" ADD FOREIGN KEY ("eventId") REFERENCES "Event"("id") ON DELETE SET NULL ON UPDATE CASCADE;
